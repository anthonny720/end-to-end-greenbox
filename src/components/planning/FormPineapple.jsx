...
import {update_kpi_pineapple} from "../../redux/actions/planning";


const FormPlanningPineapple = ({data, close,params}) => {
    const columns = [
        ...
        {name: 'objective', title: '% Objetivo producción', type: 'text', maxLength: 2},
    ...
    const formik = useFormik({
        ...
        onSubmit: (form, onSubmitProps) => {
            dispatch(update_kpi_pineapple(form, data.id,params))
            close()
        }
    })
...
const initialValues = (data) => {
    return {
        ...
        price_objective: data?.price_objective || 1.66,
...
export default FormPlanningPineapple;
