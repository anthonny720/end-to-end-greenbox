...
import {update_kpi_mango} from "../../redux/actions/planning";


const FormPlanningMango = ({data, close,params}) => {
    const columns = [
    ...
    const formik = useFormik({
        ...
        onSubmit: (form, onSubmitProps) => {
            dispatch(update_kpi_mango(form, data.id, params))
            close()
        }
    })
...
export default FormPlanningMango;
