...
const ProductionBlueberry = ({production}) => {
    return (<View style={{fontSize: "10", marginTop: 4, display: "flex", flexDirection: "row"}}>
        ...
        <View>
            ...
            <View style={styles.section}>
                <Text style={styles.text1}>Entero</Text>
                <Text style={styles.text3}>{Humanize.formatNumber(production?.retail_whole, 2)} kg</Text>
                <Text style={styles.text3}>{Humanize.formatNumber(production?.granel_whole, 2)} kg</Text>
            </View>
            <View style={styles.section}>
                <Text style={styles.text1}>Mitades</Text>
                <Text style={styles.text3}>{Humanize.formatNumber(production?.retail_halves, 2)} kg</Text>
                <Text style={styles.text3}>{Humanize.formatNumber(production?.granel_halves, 2)} kg</Text>
            </View>
...
export default ProductionBlueberry;
