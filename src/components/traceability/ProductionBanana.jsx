...
const ProductionBanana = ({production}) => {
    ...
    return (<View style={{fontSize: "10", marginTop: 4, display: "flex", flexDirection: "row"}}>
            <View>
                ...
                <View style={styles.section}>
                    <Text style={styles.text1}>Kg cáscara</Text>
            ...
            <View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text2}>{Humanize.formatNumber(production?.retail_slices, 2)} kg</Text>
                    <Text style={styles.text2}>{Humanize.formatNumber(production?.granel_whole, 2)} kg</Text>
                </View>
                <View style={styles.section}>
                    <Text style={styles.text1}>Coins</Text>
                    <Text style={styles.text2}>{Humanize.formatNumber(production?.retail_coins, 2)} kg</Text>
...
export default ProductionBanana;
