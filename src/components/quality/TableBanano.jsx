...
const Table = ({data, update}) => {
    const columns = [' ', 'Semana', 'Fecha de Ingreso', 'Lote MP', 'Peso neto', 'Jabas', 'Maduración 1 %', 'Maduración 2 %', 'Maduración Total %', 'Daños mecánicos %', 'Corte de cuello %', 'Rozadura %', 'Cicatriz %', 'Sin daños %']
    const tableRef = useRef(null);
    return (<div className="overflow-x-auto relative scrollbar-hide">
        <DownloadTableExcel
            filename="analisis-banano"
            sheet="analisis-banano"
