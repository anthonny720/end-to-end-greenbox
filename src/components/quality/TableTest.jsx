...
const Table = ({data, update}) => {
    const columns = [' ', 'Semana', 'Mes', 'Año', 'Lote', 'Calibre', '% Ojitos', 'Peso en fresco (corte 1/8)', '% Corte 1/8 en fresco', 'Peso corte <> de 1/8', '% peso corte <> de 1/8', 'Peso total por bandeja']
    const tableRef = useRef(null);
    return (<div className="overflow-x-auto relative scrollbar-hide">
        <DownloadTableExcel
            filename="Pruebas de corte"
            sheet="Hoja 1"
