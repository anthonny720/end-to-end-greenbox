...
const Table = ({data, update}) => {
    const columns = [' ', 'Semana', 'Fecha de Ingreso', 'Lote MP', 'Peso neto', 'Jabas', 'Maduración 0 %', 'Maduración 1 %', 'Maduración 2 %', 'Maduración 3 %', 'Maduración 4 %', 'Maduración 5 %', 'Maduración Total %', 'Calibre 6 %', 'Calibre 8 %', 'Calibre 10 %', 'Calibre 12 %', 'Calibre 14 %']
    const tableRef = useRef(null);
    return (<div className="overflow-x-auto relative scrollbar-hide">
        <DownloadTableExcel
            filename="Analisis de Pina"
            sheet="analisis-pina"
