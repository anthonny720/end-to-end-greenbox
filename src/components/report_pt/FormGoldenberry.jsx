...
const FormPTGoldenberry = ({data, close, params}) => {
    const columns = [
        ...
        {name: 'caliz', title: 'Caliz', type: 'text', maxLength: 8},
        {name: 'retail_whole', title: 'Retail enteros', type: 'text', maxLength: 8},
        {name: 'retail_halves', title: 'Retail mitades', type: 'text', maxLength: 8},
        {name: 'retail_quarter', title: 'Retail cuartos', type: 'text', maxLength: 8},
        {name: 'granel_whole', title: 'Granel enteros', type: 'text', maxLength: 8},
        {name: 'granel_halves', title: 'Granel mitades', type: 'text', maxLength: 8},
        {name: 'granel_quarter', title: 'Granel cuartos', type: 'text', maxLength: 8},
...
const initialValues = (data) => {
    return {
        ...
        retail_quarter: data?.retail_quarter || 0,
        granel_whole: data?.granel_whole || 0,
        granel_halves: data?.granel_halves || 0,
        granel_quarter: data?.granel_quarter || 0
