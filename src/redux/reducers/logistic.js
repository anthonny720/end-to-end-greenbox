import {
    ...
    GET_FULL_PACKING_LIST_FAIL,
    GET_FULL_PACKING_LIST_SUCCESS,
...
export default function Logistic(state = initialState, action) {
    ...
    switch (type) {
        ...
        case GET_FULL_PACKING_LIST_SUCCESS:
            return {
                ...state, full_packing_list: payload.result
            }
        case GET_FULL_PACKING_LIST_FAIL:
            return {
                ...state, full_packing_list: null
            }
