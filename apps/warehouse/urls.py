...
from apps.warehouse.views import ListReceptionView, PackingListView, IReceptionListView, IReceptionDetailView, \
    ...
    DataPackingListView, FullPackingListView

urlpatterns = [path('programs', ListReceptionView.as_view()), path('packing-list/data', AddLotPackingView.as_view()),
               ...
               path('full-packing-list', FullPackingListView.as_view()),
