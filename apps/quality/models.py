...
class CutTest(models.Model):
    ...
    eyes = models.DecimalField(max_digits=4, decimal_places=2, verbose_name='Ojitos', blank=True, null=True, default=0.0)
...
class AnalysisPineapple(models.Model):
    ...
    maturation_0_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Maduración 0 Planta %")
    maturation_1_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Maduración 1 Planta %")
    maturation_2_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Maduración 2 Planta %")
    maturation_3_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Maduración 3 Planta %")
    maturation_4_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Maduración 4 Planta %")
    maturation_5_plant = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
...
class AnalysisAguaymanto(models.Model):
    ...
    maturation_1 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                       verbose_name=u"Maduración 1 %")
    maturation_2 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                       verbose_name=u"Maduración 2 %")
    maturation_3 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                       verbose_name=u"Maduración 3 %")
    mushroom = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                   verbose_name=u"Hongos y fermentado")
    green = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True, verbose_name=u"Verde")
    cracked = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
    ...
    # small = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True, verbose_name='Pequeño < 17mm')
    # caliz = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True, verbose_name='Caliz')
    history = HistoricalRecords()
...
class AnalysisBanano(models.Model):
    ...
    maturation_2 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                       verbose_name=u"Maduración 2 %")
    mechanical_damages = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                             verbose_name=u"Daños mecánicos")
    broken_neck = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                      verbose_name=u"Corte de cuello")
    chafing = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Rozadura")
    scar = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                               verbose_name=u"Cicatriz")
    unharmed = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
...
class AnalysisBlueberry(models.Model):
    ...
    average_brix = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                       verbose_name=u"Brix promedio")
    max_brix = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                   verbose_name=u"Brix máximo")
    min_brix = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                   verbose_name=u"Brix mínimo")
    caliber_1 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                    verbose_name=u"Calibre 1 <=11")
    caliber_2 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                    verbose_name=u"Calibre 2 12 -18")
    caliber_3 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
...
class AnalysisMango(models.Model):
    ...
    color_1 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Color 1")
    color_1_5 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                    verbose_name=u"Color 1,5 ")
    color_2 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Color 2")
    color_2_5 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                    verbose_name=u"Color 2,5")
    color_3 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Color 3")
    color_3_5 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                    verbose_name=u"Color 3,5")
    brix_7 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                   verbose_name=u"Brix < 7")
    brix_7_8 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                     verbose_name=u"Brix 7-8")
    brix_8_9 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Brix 8-9")
    brix_9 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                   verbose_name=u"Brix > 9")
    weight_280 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                     verbose_name=u"Peso <280 ")
    weight_280_300 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                         verbose_name=u"Peso 280-300 ")
    weight_300 = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                     verbose_name=u"Peso >300 ")
    mechanical_damage = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                            verbose_name=u"Daños mecanicos")
    cracked = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
                                  verbose_name=u"Rajado")
    sun_damage = models.DecimalField(decimal_places=2, max_digits=4, default=0.0, blank=True, null=True,
