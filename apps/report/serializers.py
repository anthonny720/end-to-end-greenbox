...
class ReportPTSerializer(serializers.ModelSerializer):
    percentage_discarded = serializers.FloatField(source='get_percentage_discarded', read_only=True)
    net_weight = serializers.FloatField(source='get_net_weight', read_only=True)
    percentage_merma = serializers.FloatField(source='get_percentage_merma', read_only=True)
...
class ReportPTMangoSerializer(ReportPTSerializer):
    ...
    kg_guide = serializers.FloatField(source='lot.weight_guide', read_only=True)
    kg_net = serializers.FloatField(source='lot.get_total_net_weight', read_only=True)
    discount_percentage = serializers.FloatField(source='lot.discount_percentage', read_only=True)
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    percentage_shell = serializers.FloatField(source='get_percentage_shell', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
    kg_pt = serializers.FloatField(source='get_kg_pt', read_only=True)
    performance_usable = serializers.FloatField(source='get_performance_usable', read_only=True)
    performance_net = serializers.FloatField(source='get_performance_net', read_only=True)
...
class ReportPTPineappleSerializer(ReportPTSerializer):
    ...
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    percentage_crown = serializers.FloatField(source='get_percentage_crown', read_only=True)
    percentage_shell = serializers.FloatField(source='get_percentage_shell', read_only=True)
    percentage_juice_pulp = serializers.FloatField(source='get_percentage_juice_pulp', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
    kg_pt = serializers.FloatField(source='get_kg_pt', read_only=True)
    performance_usable = serializers.FloatField(source='get_performance_usable', read_only=True)
...
class ReportPTGoldenberrySerializer(ReportPTSerializer):
    ...
    discount_percentage = serializers.FloatField(source='lot.discount_percentage', read_only=True)
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    percentage_caliz = serializers.FloatField(source='get_percentage_caliz', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
    kg_pt = serializers.FloatField(source='get_kg_pt', read_only=True)
    performance_usable = serializers.FloatField(source='get_performance_usable', read_only=True)
...
class ReportTraceabilityMangoSerializer(ReportPTSerializer):
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    percentage_shell = serializers.FloatField(source='get_percentage_shell', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
...
class ReportTraceabilityPineappleSerializer(ReportPTSerializer):
    ...
    class Meta:
        model = ReportPTPineapple
        fields = ('date_process','kg_processed', 'dehydrated', 'kg_discarded', 'percentage_discarded',
                  'net_weight', 'crown', 'percentage_crown', 'shell', 'percentage_shell',
                  'juice_pulp', 'percentage_juice_pulp', 'merma', 'percentage_merma',
                  'kg_enabled', 'percentage_enabled', 'kg_pt',
                  'retail_rings',
...
class ReportTraceabilityBananaSerializer(ReportPTSerializer):
...
class ReportTraceabilityGoldenberrySerializer(ReportPTSerializer):
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    percentage_caliz = serializers.FloatField(source='get_percentage_caliz', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
...
class ReportTraceabilityBlueberrySerializer(ReportPTSerializer):
    dehydrated = serializers.FloatField(source='get_dehydrated', read_only=True)
    kg_enabled = serializers.FloatField(source='get_kg_enabled', read_only=True)
    percentage_enabled = serializers.FloatField(source='get_percentage_enabled', read_only=True)
    kg_pt = serializers.FloatField(source='get_kg_pt', read_only=True)
