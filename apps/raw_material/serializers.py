...
from apps.raw_material.models import *
...
class LotDetailSerializer(serializers.ModelSerializer):
    ...
    tc = serializers.CharField(source='get_doc_tc', read_only=True)
    invoice = serializers.CharField(source='get_doc_invoice', read_only=True)
